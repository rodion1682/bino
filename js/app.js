...
// фильтр товаров (filter) 1

function app() {
	const buttons = document.querySelectorAll('.tabs-works__item');
	const cards = document.querySelectorAll('.cards-tabs__item');
...
new Swiper('.welcome__slider', {
	wrapperClass: "welcome__body",
	slideClass: "welcome__slide",
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 0,
...
new Swiper('.services__slider', {
	wrapperClass: "slider-services__body",
...
new Swiper('.slider-case__wrapper', {
	wrapperClass: "slider-case__body",
	slideClass: "slider-case__slide",
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 0,
...
let filterContainer = document.querySelector('.tabs-works__navigation');
let galleryItems = document.querySelectorAll('.cards-tabs__item');

if (filterContainer && galleryItems) {
	filterContainer.addEventListener('click', (event) => {
		if (event.target.classList.contains('tabs-works__item')) {
...
const startedToTop = document.querySelector('.started__to-top');

startedToTop.addEventListener('click', () => {
	window.scrollTo({
		top: 0,
		behavior: 'smooth'
	});
